...
const CreatePost = ()=>{
  ...
  const postDetails = ()=>{
    ...
    data.append("cloud_name","harshks")             /**cloud name - harshks */
    fetch("https://api.cloudinary.com/v1_1/harshks/photo/upload",{    /**"https://api.cloudinary.com/v1_1/harshks" - api base url   */
      method:"post",
      body:data
    })
    .then(res=>res.json())
